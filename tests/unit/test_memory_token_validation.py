...
def test_memory_api_request_schemas_expose_only_supported_client_fields() -> None:
    assert set(MemoryCreateRequest.model_fields) == {
        "dedupe_key",
        "content",
        "memory_key",
        "memory_type",
    ...
    assert set(MemoryUpdateRequest.model_fields) == {
        "memory_id",
        "expected_version",
        "dedupe_key",
        "content",
    ...
    assert set(MemorySettingsUpdateRequest.model_fields) == {
        "auto_organize_enabled",
        "organization_channel_id",
        "organization_model_id",
    }
    assert set(MemoryOrganizeRequest.model_fields) == {"dedupe_key"}
