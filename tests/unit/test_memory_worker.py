...
async def memory_session_factory(tmp_path) -> AsyncIterator[async_sessionmaker[AsyncSession]]:
    database_path = tmp_path / "memory-worker-memory_worker.db"
...
@pytest.mark.asyncio
async def test_default_memory_worker_executor_operations_and_factory_are_shared(
