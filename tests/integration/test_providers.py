...
async def test_provider_full_lifecycle():
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://test") as ac:
        ...
        r_err_type = await ac.post("/api/v1/providers/create", json={"name": "P1", "provider_type": "INVALID", "api_key": "k"}, headers=headers)
        ...
        # 1. 正常创建
        r_ok = await ac.post("/api/v1/providers/create", json={"name": "P1", "provider_type": "OPENAI", "api_key": "k1"}, headers=headers)
