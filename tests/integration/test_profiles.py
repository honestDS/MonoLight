...
async def test_profile_management_full_flow():
    async with AsyncClient(
        ...
        r_p = await ac.post(
            ...
            json={"name": "P1", "provider_type": "OPENAI", "api_key": "k"},
            headers=headers,
        )
