...
class ProfileBase(BaseModel):
    ...
    provider_id: int = Field(..., examples=[1])
    model_id: str = Field(..., examples=["gemini-3-flash-preview"])
    ...
    prompt_id: Optional[int] = Field(None, examples=[1])
    uid: Optional[int] = None
    is_active: Optional[bool] = False
    audit_provider_id: Optional[int] = Field(None, examples=[0])
...
class ProfileCreate(ProfileBase):
    ...
    audit_provider_id: Optional[int] = None
