...
class SecurityConfig(BaseModel):
    """安全审计系统参数配置"""
    audit_provider_id: Optional[int] = PydanticField(None, gt=0, description="执行安全审计的提供商 ID")
    audit_model_id: Optional[str] = PydanticField(None, description="用于审计的具体模型 ID")
