MESSAGES = {
    ...
    "ERR_CHANNEL_MODEL_CONTEXT_WINDOW_REQUIRED": "Chat models must specify a context window.",
    "ERR_CHANNEL_MODEL_MAX_TOKENS_EXCEEDS_CONTEXT_WINDOW": "Maximum output tokens ({max_tokens}) plus the safety margin ({safety_margin_tokens} tokens) must leave a positive input budget within the {context_window_k}K context window ({context_window_tokens} tokens).",
    ...
    "ERR_CHANNEL_MODEL_LOCKED": "This model is organizing long-term memory or waiting to be removed automatically. It cannot be selected, edited, or deleted until the task finishes.",
    "ERR_CHANNEL_MODEL_LIFECYCLE_MANAGED": "The model deletion status is handled automatically. Please do not change it manually.",
    "ERR_CHANNEL_MODEL_PENDING_DELETE_ENABLED": "A model pending deletion must be disabled.",
