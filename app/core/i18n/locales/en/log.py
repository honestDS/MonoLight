MESSAGES = {
    ...
    "LOG_AUDIT_PROVIDER_DISABLED": "Audit model provider is disabled, skipping security audit",
    ...
    "LOG_CHANNEL_MODEL_ENTRY_NOT_FOUND": "No model entry matching model_id and usage was found in Provider",
    "LOG_CHANNEL_NO_RULES": "No routing rules",
    "LOG_CHANNEL_PROVIDER_UNAVAILABLE": "Channel Provider does not exist or is disabled",
