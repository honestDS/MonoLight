MESSAGES = {
    ...
    "LOG_AUDIT_PROVIDER_DISABLED": "审计模型提供商已被禁用，跳过安全审计",
    ...
    "LOG_CHANNEL_MODEL_ENTRY_NOT_FOUND": "Provider 中未找到匹配 model_id 与 usage 的模型条目",
    "LOG_CHANNEL_NO_RULES": "没有路由规则",
    "LOG_CHANNEL_PROVIDER_UNAVAILABLE": "渠道对应的 Provider 不存在或已禁用",
