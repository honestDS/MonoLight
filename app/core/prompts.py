...
When file_tool has truncated top-level argument_evidence, the corresponding arguments field contains only the visible prefix: content for operation=write, pattern and replacement for operation=replace, and pattern for operation=find. Summarize from the relevant prefix and its metadata, and explicitly state that the remaining content was not verified.
