export default {
  ...
  status_retry: 'Retry',
  backend_unavailable_status: 'Connection failed',
  backend_unavailable_title: 'Cannot connect to the service',
  backend_unavailable_description: 'Unable to connect to the service. Please contact your administrator to report the issue.',
  backend_unavailable_retry: 'Retry',
