...
const requiredMemoryKeys = [
  ...
  'scope_placeholder', 'updated_at', 'created_at', 'importance', 'version', 'descending', 'ascending',
  ...
  'memory_key_placeholder', 'content_placeholder', 'change_evidence_placeholder', 'importance_hint',
